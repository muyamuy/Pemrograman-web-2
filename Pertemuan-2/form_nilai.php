...
<body>
    <div class="mx-4">
        ...
        <form method="GET" action="proses_nilai.php">
            ...
            <div class="form-group row">
                <label for="praktik" class="col-4 col-form-label">Nilai Praktikum</label>
                <div class="col-8">
                    <input id="praktik" name="praktik" placeholder="Masukkan Nilai Praktikum" type="text" class="form-control" required="required">
                </div>
            </div>
            <div class="form-group row">
